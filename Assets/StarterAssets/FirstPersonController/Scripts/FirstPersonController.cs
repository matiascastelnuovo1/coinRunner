...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		public bool _poweredJump = false;
		public bool _poweredSpeed = false;
		...
		private void Update()
		{
			...
			{
				audioManager.isMoving = true;
			}
			else
			{
				audioManager.isMoving = false;
			}
		}
		...
		// modify jump and speed if a powerup is active
		public void powerJump()
		{
			JumpHeight = _poweredJump ? 13 : 1.2f;
		}

		public void powerSpeed()
		{
			SprintSpeed = _poweredSpeed ? 25.0f : 15.0f;
		}
	}
}